...
Imports System.IO
Public Class Rs232Class : Implements IDisposable
    '===================================================
    '
    '	Module				:	Rs232
...
#Region "Delegates"
    Public Delegate Sub CommEventHandler(ByVal source As Rs232Class, ByVal Mask As EventMasks)
#End Region
    ...
    Public Sub PurgeBuffer(ByVal Mode As PurgeBuffers)
        'This method will clear any character into buffer, use TxAbort/RxAbort
    ...
    Public Overloads Sub Open()
        'Initializes and Opens comunication port
    ...
    Public Overloads Sub Open(ByVal Port As Integer, ByVal BaudRate As Integer, ByVal DataBit As Integer, ByVal Parity As DataParity, ByVal StopBit As DataStopBit, ByVal BufferSize As Integer)
        'Opens comunication port (Overloaded method)
        Me.Port = Port
    ...
    Public Sub ClearInputBuffer()
        'Gets all character until end of buffer
    ...
    Public Sub EnableEvents()
        'Enables monitoring of incoming events
    ...
    Public Sub DisableEvents()
        'Disables monitoring of incoming events
    ...
    Public Property RxBufferThreshold() As Int32
        'Numer of characters into input buffer
    ...
    Public Shared Function IsPortAvailable(ByVal portNumber As Int32) As Boolean
        'Returns true if a specific port number is supported by the system
    ...
    Public ReadOnly Property InBufferCount() As Int32
        'Returns the number of bytes inside Rx buffer
        Get
...
#Region "Protected Routines"
    Protected Sub OnCommEventReceived(ByVal source As Rs232Class, ByVal mask As EventMasks)
        '===================================================
        '												©2003 www.codeworks.it All rights reserved
        '
