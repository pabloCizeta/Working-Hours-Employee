...
#Region "Public Functions"
    ...
    Public Shared Function WipeFile(ByVal Filename As String) As Boolean
        If Not File.Exists(Filename) Then
            _exception = New CryptographicException(ERR_NO_FILE)
            Return False
        End If

        Dim b() As Byte = My.Computer.FileSystem.ReadAllBytes(Filename)
        For i As Integer = 0 To b.Length - 1
            b(i) = 88
        Next
        My.Computer.FileSystem.WriteAllBytes(Filename, b, False)
